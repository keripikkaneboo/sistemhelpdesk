...
export default function CustomSelect({
  ...
  placeholder = "Pilih...", disabled = false, size = "sm", className = "",
}: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`w-full flex items-center justify-between gap-2 border border-gray-300 rounded-lg px-4 ${triggerSize} bg-white outline-none focus:ring-2 focus:ring-red-500 transition ${
      ...
      >
        ...
        <svg
          className={`w-4 h-4 shrink-0 text-gray-500 transition-transform duration-150 ${open ? "rotate-180" : ""}`}
